...
Relational Databases is the data stored and the structure of it. Relational Databases structure is a collection of rows and is called a table. SQL is the language that manages the databases and the data in them. This is how you interact with the database

- [ ] Why do tables need a `primary key`?
It is the sole way to uniquely identify each record in the database.
